        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NavigationGameId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EducationalGamesId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_EducationalGames_EducationalGamesId",
                        column: x => x.EducationalGamesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DyslexiaDiagnosis_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeSpent = table.Column<TimeSpan>(type: "time", nullable: false),
                    GameSessionId = table.Column<int>(type: "int", nullable: false),
                    EducationalGameId = table.Column<int>(type: "int", nullable: false),
                    DyslexiaDiagnosisId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NavigationGames_EducationalGames_EducationalGameId",
                        column: x => x.EducationalGameId,
                        principalTable: "EducationalGames",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameSessions_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.NavigationGameId,
                        principalTable: "NavigationGames",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "EducationalGameGameSession",
                columns: table => new
                {
                    EducationalGamesId = table.Column<int>(type: "int", nullable: false),
                    GameSessionsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EducationalGameGameSession", x => new { x.EducationalGamesId, x.GameSessionsId });
                    table.ForeignKey(
                        name: "FK_EducationalGameGameSession_EducationalGames_EducationalGamesId",
                        column: x => x.EducationalGamesId,
                        principalTable: "EducationalGames",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EducationalGameGameSession_GameSessions_GameSessionsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_EducationalGamesId",
                table: "AspNetUsers",
                column: "EducationalGamesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DyslexiaDiagnosis_UsersId",
                table: "DyslexiaDiagnosis",
                column: "UsersId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationalGameGameSession_GameSessionsId",
                table: "EducationalGameGameSession",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NavigationGames_EducationalGameId",
                table: "NavigationGames",
                column: "EducationalGameId");
